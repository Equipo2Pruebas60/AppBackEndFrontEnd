...
<body>
							...
							<div class="d-grid gap-2">
								<button class="navbar-toggler" type="button"
									...
									<span class="navbar-toggler-icon"></span>
										...
										<li class="btn btn-primary mt-3"><a class="nav-link active" href="reportesclientes.jsp"style="color:white;">...REPORTE...					
				...
				<table
					...
					<thead>
						<tr>
							...
							<td class="text-lowercase" style="font-size: 16px;">Direcciòn</td>
							<td class="text-lowercase" style="font-size: 16px;">Correo Electronico</td>
	...
	<script src="scripts/reportesclientes.js"></script>
